class Car {
    ...
    Car() {
        System.out.println("This is a Default Constructor used to initialize the instance variables");
        name = model = company = null;
        price = 0.0f;
    }

    Car(String name, String model, String company, float price) {
        System.out.println("This is a Parameterized Constructor used to initialize the instance variables");
...
public class Constructors {
    public static void main(String[] args) {
        ...
        Car c2 = new Car("Supra", "mk4", "Toyota", 85);
...
/*
Constructor: A Constructor in java is a type of special method that invokes automatically when an object of that class is created.
